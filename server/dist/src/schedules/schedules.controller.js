...
const validate_dates_pipe_1 = require("./pipes/validate-dates/validate-dates.pipe");
let SchedulesController = class SchedulesController {
    schedulesService;
    constructor(schedulesService) {
        this.schedulesService = schedulesService;
    }
    create(userCreatorId, userAsignedId, createScheduleDto) {
        return this.schedulesService.create(userCreatorId, userAsignedId, createScheduleDto);
    }
    findAll() {
...
__decorate([
    (0, common_1.Post)('create/:userCreatorId/:userAsignedId'),
    __param(0, (0, common_1.Param)('userCreatorId')),
    __param(1, (0, common_1.Param)('userAsignedId')),
    __param(2, (0, common_1.Body)(validate_dates_pipe_1.ValidateDatesPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, create_schedule_dto_1.CreateScheduleDto]),
